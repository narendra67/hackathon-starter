...
//routes for sports page
app.get('/create', sportsController.createSportForm);
app.post('/createSport', sportsController.createSport);
app.post('/createSports', sportsController.createSports);
